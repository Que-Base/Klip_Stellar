...
class $AssetsPngGen {
  ...
  /// File path: assets/png/blured_background.png
  AssetGenImage get bluredBackground =>
      const AssetGenImage('assets/png/blured_background.png');

  /// List of all assets
  List<AssetGenImage> get values => [bluredBackground];
}
...
class $AssetsSvgIconsGen {
  ...
  SvgGenImage get downloadIcon =>
      const SvgGenImage('assets/svg_icons/download_icon.svg');

  /// File path: assets/svg_icons/drop_down_icon.svg
  ...
  SvgGenImage get savingTabIcon =>
      const SvgGenImage('assets/svg_icons/saving_tab_icon.svg');

  /// File path: assets/svg_icons/setting_tab_icon.svg
  SvgGenImage get settingTabIcon =>
      const SvgGenImage('assets/svg_icons/setting_tab_icon.svg');
  ...
  SvgGenImage get transactionTabIcon =>
      const SvgGenImage('assets/svg_icons/transaction_tab_icon.svg');

  /// File path: assets/svg_icons/waiting_icon.svg
  SvgGenImage get waitingIcon =>
      const SvgGenImage('assets/svg_icons/waiting_icon.svg');

  /// File path: assets/svg_icons/wallet_icon.svg
  SvgGenImage get walletIcon =>
      const SvgGenImage('assets/svg_icons/wallet_icon.svg');

  /// File path: assets/svg_icons/wallet_scan_icon.svg
